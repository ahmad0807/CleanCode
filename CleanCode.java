public class main 
{
    ...
    static CheckClean FindingHighest&Lowest(int GivenArray[], int SizeOfArray) //Method to Find Highest and lowest value from Array//
    {
    ...
    public static void main(String args[]) //Main method//
    {
        ...
        int SizeOfArray = 6;
        CheckClean objectOfCheck = FindingHighest&Lowest(GivenArray, SizeOfArray); // passing value of array according to size//
